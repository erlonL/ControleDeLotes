...
- [ ] Lógica para aba de clientes -> NÃO adicionar clientes com informações inválidas (renda anual como string, profissão com número).
...
<img alt="main-page.png" src="media/main-page.png" width="800">

### Aba de lotes

<img alt="lotes.png" src="media/lotes.png" width="800">

### Aba de Clientes

<img alt="clientes.png" src="media/clientes.png" width="800">

### Aba de Vendedores

<img alt="vendedores.png" src="media/vendedores.png" width="800">

### Aba de Vendas

<img alt="vendas.png" src="media/vendas.png" width="800">

### Menu Trocar Visualização

<img alt="menu.png" src="media/menu.png" width="800">
